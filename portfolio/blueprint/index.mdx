...
featured_image_alt: ''
project_link: 'https:/wwww.jimappleg8.com/blueprint'
button_icon: 'faBookOpen'
button_text: 'Learn More'
lead_text: 'An e-commerce website hosted on AWS. I configured a secure infrastructure on AWS, and worked with the developers, internal IT folks, fulfillment house, payment gateway, and PCI compliance folks to get it all connected, certified as secure, and up and running.'
---
